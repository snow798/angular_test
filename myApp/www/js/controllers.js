...
.controller('main', function($scope) {
    ...
    //banner
    .controller('main_slideBox', function($scope) {

    })
    //loanlist
    .controller('main_loanList', function($scope,$ionicSlideBoxDelegate) {
        $scope.nextSlide = function() {
            $ionicSlideBoxDelegate.next();
        }
    })
    //chart
    .controller('main_showListimg', ['$scope', 'pageService', 'chartService', function ($scope, pageService, chartService) {

    if (!$scope.chartTemplate) {
        //get the chart template for this view... right now it covers all charts...
        pageService.get(null, '/$load/common/charts/highcharts.json').then(function (success) {
